...
const ChangeAvatar = ({ onSave, onClose }: any) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 z-50">
      ...
      <div className="flex items-center mb-4">
        <input type="file" accept="image/*" className="hidden" onChange={handleFileChange} id="fileInput" />
      ...
      <div className="flex justify-end">
        ...
        <button className="bg-gray-300 text-black px-4 py-2 rounded-md hover:bg-gray-400" onClick={onClose}>
          Hủy
        </button>
      </div>
    </div>
